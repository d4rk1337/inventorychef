package net.d4rk.inventorychef.inventory.expandablelistview.roomembedded;
...
public class RecyclerItemTouchHelper
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((ExpandableInventoryAdapter.IngredientViewHolder) viewHolder).viewForeground;
